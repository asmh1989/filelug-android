...
/**
 * Cursor wrapper for the {@code upload_history} table.
 */
public class UploadHistoryCursor extends AbstractCursor implements UploadHistoryModel {
    public UploadHistoryCursor(Cursor cursor) {
        super(cursor);
    }
     ...
     */
    public long getId() {
        Long res = getLongOrNull(UploadHistoryColumns._ID);
        if (res == null)
    ...
    public String getComputerGroup() {
        String res = getStringOrNull(UploadHistoryColumns.COMPUTER_GROUP);
        if (res == null)
    ...
    public String getComputerName() {
        String res = getStringOrNull(UploadHistoryColumns.COMPUTER_NAME);
        if (res == null)
    ...
    public long getFileSize() {
        Long res = getLongOrNull(UploadHistoryColumns.FILE_SIZE);
        if (res == null)
    ...
    public long getEndTimestamp() {
        Long res = getLongOrNull(UploadHistoryColumns.END_TIMESTAMP);
        if (res == null)
    ...
    public String getFileName() {
        String res = getStringOrNull(UploadHistoryColumns.FILE_NAME);
        return res;
    }
    ...
    public String getUserId() {
        String res = getStringOrNull(UploadHistoryColumns.USER_ID);
        if (res == null)
    ...
    public int getComputerId() {
        Integer res = getIntegerOrNull(UploadHistoryColumns.COMPUTER_ID);
        if (res == null)
