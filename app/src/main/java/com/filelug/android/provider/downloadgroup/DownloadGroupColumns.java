...
/**
 * Columns for the {@code download_group} table.
 */
public class DownloadGroupColumns implements BaseColumns {
    public static final String TABLE_NAME = "download_group";
    ...
    public static boolean hasColumns(String[] projection) {
        ...
        for (String c : projection) {
            ...
            if (c.equals(LOCAL_PATH) || c.contains("." + LOCAL_PATH)) return true;
